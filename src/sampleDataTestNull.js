...
import {keyCollisionTest} from './dataTest.js'

const f1 = 'avro/sample_avro/userdata4.avro';
const f2 = 'avro/sample_avro/userdata4.avro';
const k = ['id'];
const schema = {
  "type" : "record",
  "name" : "kylosample",
...
const opts = {
  "schema": schema,
  "codecs": null,
  "keepFields": ['id', 'first_name', 'last_name'],
  "ignoreFields": null
};

setConfig(opts);
keyCollisionTest(f1, f2, k);
